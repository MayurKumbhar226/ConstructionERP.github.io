...
<body>
								<table class="table">
								  ...
								  <tr>
								    ...
								    <th>Project Name:</th>
								    <th>Address :</th>  
								    <th>Add Architect/Engineer :</th>  
									<th>Add Task to Employee :</th>
									<th>Add Task to Department :</th> 
									<th>Delete :</th> 
								...
								{%>
								  <tr>
								    <td><%=rs.getString(1)%></td>
									 ...
									 <td><a href="responsible_for_engineer.jsp?project_id=<%=rs.getInt(1) %>">Add Engineer</a></td>
								  
									<td><a href="responsible_for_emp.jsp?project_id=<%=rs.getInt(1) %>">Add Employee</a></td>
								     <td><a href="responsible_for_dep.jsp?project_id=<%=rs.getInt(1) %>">Add Department</a></td>
