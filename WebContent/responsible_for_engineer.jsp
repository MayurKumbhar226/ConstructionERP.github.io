...
<form  action = "Add_engineer_to_project" method = "post">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-xl-9">
			...
			<input type="number" name="project_id11" class="form-control" placeholder="Project id" value=<%=pid%> required> 
			</div>
			...
			<input type="email" name="project_eng_emial" class="form-control" placeholder="Enter engineer Email" required> 
			</div>
			

			<div class="custom-select" style="width:200px;">
			  <select name="responsible_engi">
			    <option value="0">Select_menu:</option>
			    <%
			    
			   	try
			   	{
			   		String Query="select * from engineers_account";
					...
					while(rs.next())
					{
						...
						<option value="<%=rs.getInt("engineer_id")%>"><%=rs.getString("engineer_name")%></option>
...
<div class="container">
<p><a href="templateshub.net">mayur</a></p>
</div>
</footer>
