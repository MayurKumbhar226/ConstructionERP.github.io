...
<form  action = "Add_deparment_task" method = "post">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-xl-9">
			...
			<div class="form-group"> 
			<label for="exampleInputEmail1">Enter Engineer Email</label> 
			<input type="email" name="eng_email" class="form-control" placeholder="Enter Engineer Email" required> 
			</div>
			
			 <div class="form-group"> 
			<label for="exampleInputEmail1">Employee Task Title</label> 
			<input type="text" name="empTitle" class="form-control"  placeholder="Enter Employee Task Assigner" required> 
			</div>
            
            <div class="form-group"> 
			<label for="exampleInputEmail1">Employee Task Assigner</label> 
			<input type="text" name="empAssig" class="form-control"  placeholder="Enter Employee Task Assigner" required> 
			</div>
            
            
            <div class="form-group">
			<label for="exampleInputEmail1">Employee Task Priority</label> 
			<input type="text" name="EmpPrio" class="form-control"  placeholder="Enter Employee Task Priority" required> 
			...
			<input type="date" id="start" name="empdate_start"
       		value="2018-07-22"
			...
			<input type="date" id="start" name="empdate_end"
       		value="2018-07-22"
       		min="2018-01-01" max="2018-12-31">
			 </div>
			...
			<div class="form-group">
			<label for="exampleInputEmail1">Employee Task Location</label> 
			<input type="text" name="emp_task_location" class="form-control"  placeholder="Enter Employee task Location" required>  
